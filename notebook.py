...
def _(datetime):
    def parse_utc(raw_value: str) -> datetime:
        ...
        if not isinstance(raw_value, str):
            raise TypeError("El timestamp debe ser una cadena de texto.")
        ...
        try:
            ...
            raise ValueError(
                f"Timestamp inválido: {raw_value}"
            ) from exc
...
def _(datetime):
    def assign_fixed_window(
        ...
        window_start_seconds = (
            timestamp_seconds // size_seconds
        ) * size_seconds
...
def _(
    ...
    class DeduplicatePayments(beam.DoFn):
        ...
        def process(
            ...
            expiry.set(
                window.end + self.allowed_lateness_seconds
            )
